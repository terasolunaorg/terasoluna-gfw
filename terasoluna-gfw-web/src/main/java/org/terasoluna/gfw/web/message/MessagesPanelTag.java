 ...
 * </p>
 * <p>
 * When messagesPanel is set to use {@code ResultMessages} (default)
 * </p>
 * <p>
 * By default values, configuration elements of {@code messagesPanel} are set to following values<br>
 ...
 * </p>
 * <p>
 * Resulting Output must be<br>
 * <pre>
 * &lt;div class=&quot;alert alert-success&quot;&gt;&lt;ul&gt;&lt;li&gt;Hello World!!&lt;/li&gt;&lt;/ul&gt;&lt;/div&gt;<br>
 * </pre>
 * </p>
 * <p>
 * By default, a combination of, ``alert`` and any one of ``alert-success,alert-info,alert-warn,alert-error`` classes of bootstrap, is used in ``messagesPanel`` <br>
 * the suffix after ``alert-`` is specified using ``type`` of ResultMessages
 * </p>
 * <p>
 * When the message is in {@code String} and {@code messagesPanel} is using default values<br>
 * </p>
 * <p>
 ...
 * </p>
 * <p>
 * When the message is in {@code String} and {@code messagesPanel} is using non-default values<br>
 * </p>
 * <p>
 * Case of not using ResultMessages:
 * </p>
 * <pre>
 ...
 * </p>
 */
public class MessagesPanelTag extends HtmlEscapingAwareTag {
     ...
     * @throws JspException In case when {@link JspException} is generated later in the chain when tag configured by MessagesPanel could not be created
     ...
     * <p>
     * If messages stored in the model is in the form of a class that extends {@code Iterable} or an Array, {@link #writeMessage(TagWriter, Object)} is called multiple times, to write<br>
     * {@link #innerElement} and messages.<br>
     * 
     * If there is only a single message, this method calls {@link #writeMessage(TagWriter, Object)} is called only once
     * </p>
     * @param tagWriter
     * @param message
     ...
     * @param tagWriter
     * @param message
     * @throws JspException Occurs when {@link #JspTagException} occurs in case when nothing is set in the configuration of the tag that configures MessagePanel using tagWriter. 
     */
     ...
     * {@code ResultMessage} is returned after conversion using {@link #getText(ResultMessage resultMessage)}. {@code Throwable} is returned after text conversion.<br> 
    ...
    /**
     * Returns the String after the code set in {@code ResultMessage} undergoes messageSource conversion in line with the locale.
     * <p>
     * </p>
     ...
     * If the data-type of Object passed as parameter is {@code ResultMessages}, then fetches the type set inside {@code ResultMessages} and returns it. <br>
     * If {@link #messagesType} is has not been set (doesn't contains value) and data-type of passed parameter is also not {@code ResultMessages}, then return empty string.
     * </p>
