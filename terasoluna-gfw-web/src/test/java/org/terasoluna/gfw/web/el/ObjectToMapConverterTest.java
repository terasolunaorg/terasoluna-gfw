...
public class ObjectToMapConverterTest {
    ...
    public void test9_propertiesIsNull() {
        ...
        assertThat(map.size(), is(5));
        assertThat(map, hasEntry("customEnum", ""));
        assertThat(map, hasEntry("date", ""));
        assertThat(map, hasEntry("integer", ""));
        assertThat(map, hasEntry("jodaLocalDate", ""));
        assertThat(map, hasEntry("nestedForm2.integer", ""));
    }
