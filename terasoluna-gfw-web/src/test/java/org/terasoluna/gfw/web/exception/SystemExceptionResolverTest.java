...
public class SystemExceptionResolverTest {
    ...
    public void testSetExceptionCode_exception_code_is_notnull() {
        ...
        assertThat(mockRequest.getAttribute("exceptionCode").toString(),
                is("code001"));
    ...
    public void testSetResultMessages_BusinessException_flashMap_is_notnull() {
        ...
        assertSame(resultMessages, flashMap
    ...
    public void testSetExceptionInfo() {
        ...
        assertThat(mockRequest.getAttribute("exceptionCode").toString(),
                is("defaultCode"));
        assertThat(mockResponse.getHeader("X-Exception-Code"),
                is("defaultCode"));
        assertSame(resultMessages, flashMap
                .get(ResultMessages.DEFAULT_MESSAGES_ATTRIBUTE_NAME));
