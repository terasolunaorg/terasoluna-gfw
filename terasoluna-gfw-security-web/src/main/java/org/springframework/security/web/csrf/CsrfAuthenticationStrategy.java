...
/**
 * {@link CsrfAuthenticationStrategy} is in charge of removing the {@link CsrfToken} upon authenticating. A new
 * {@link CsrfToken} will then be generated by the framework upon the next request.
 * @author Rob Winch
 * @since 3.2
 */
