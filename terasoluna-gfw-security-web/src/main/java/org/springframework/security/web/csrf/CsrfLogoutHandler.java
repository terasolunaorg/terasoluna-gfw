...
/**
 * {@link CsrfLogoutHandler} is in charge of removing the {@link CsrfToken} upon logout. A new {@link CsrfToken} will then be
 * generated by the framework upon the next request.
 * @author Rob Winch
 * @since 3.2
 */
