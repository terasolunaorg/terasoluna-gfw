...
/**
 * An API to allow changing the method in which the expected {@link CsrfToken} is associated to the {@link HttpServletRequest}.
 * For example, it may be stored in {@link HttpSession}.
