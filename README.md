...
All modules included in TERASOLUNA Server Framework for Java (5.x) Common Library are listed up in the [development guideline](https://terasolunaorg.github.io/guideline/5.9.0.RELEASE/ja/Overview/FrameworkStack.html#frameworkstack-common-library).
