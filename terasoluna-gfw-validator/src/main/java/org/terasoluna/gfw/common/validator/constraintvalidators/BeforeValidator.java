...
import org.terasoluna.gfw.common.validator.constraints.Before;

/**
 * Constraint validator class of {@link Before} annotation.
 * <p>
 * Validate the object whose value must be a date time whose value must be before(not allow equal) the specified date time.
 * </p>
 * @since 5.1.0
...
public class BeforeValidator implements ConstraintValidator<Before, Object> {
    ...
    /**
     * Class name of Java8 Date and Time API used to determines that the class has been loaded.
     */
    private static final String CHRONO_CLASS_NAME = "java.time.chrono.ChronoLocalDateTime";

    /**
     * Class name of JodaTime API used to determines that the class has been loaded.
     */
