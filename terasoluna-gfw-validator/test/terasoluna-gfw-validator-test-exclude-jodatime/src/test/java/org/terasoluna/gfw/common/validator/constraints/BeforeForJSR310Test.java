...
import org.terasoluna.gfw.common.validator.constraints.BeforeForJSR310Test.BeforeForJSR310TestForm;

import lombok.Data;

/**
 * Test class of {@link Before} for JSR310 Date and Time API
 */
public class BeforeForJSR310Test
                                extends
                                AbstractConstraintsTest<BeforeForJSR310TestForm> {

    private static final String MESSAGE_VALIDATION_ERROR = "must be before %s";

    @org.junit.Before
    public void before() {
        form = new BeforeForJSR310TestForm();
    }
    ...
    /**
     * for {@link ZonedDateTime} property. specify value. expected valid if input value is before(less than) value.
     * @throws Throwable
     */
    @Test
    public void testSpecifyValueForZonedDateTime() throws Throwable {
        ...
        {
            form.setZonedDateTimeProperty(ZonedDateTime
                    .parse("2015-09-30T00:00:00+09:00[Asia/Tokyo]"));
    ...
    /**
     * for {@link ZonedDateTime} property. specify format. expected valid if input value is before(less than) value parsed
     * specified format.
     * @throws Throwable
     */
    @Test
    ...
    /**
     * for {@link OffsetDateTime} property. specify value. expected valid if input value is before(less than) value.
     * @throws Throwable
     */
    @Test
    public void testSpecifyValueForOffsetDateTime() throws Throwable {
        ...
        {
            form.setOffsetDateTimeProperty(OffsetDateTime
                    .parse("2015-09-30T00:00:00+09:00"));
    ...
    /**
     * for {@link OffsetDateTime} property. specify format. expected valid if input value is before(less than) value parsed
     * specified format.
     * @throws Throwable
     */
    @Test
    ...
    /**
     * for {@link OffsetTime} property. specify value. expected valid if input value is before(less than) value.
     * @throws Throwable
     */
    @Test
    public void testSpecifyValueForOffsetTime() throws Throwable {
        ...
        {
            form.setOffsetTimeProperty(OffsetTime.parse("15:10:00+09:00"));
    ...
    /**
     * for {@link OffsetTime} property. specify format. expected valid if input value is before(less than) value parsed
     * specified format.
     * @throws Throwable
     */
    @Test
    ...
    /**
     * for {@link Year} property. specify value. expected valid if input value is before(less than) value.
     * @throws Throwable
     */
    @Test
    public void testSpecifyValueForYear() throws Throwable {
        ...
        {
            form.setYearProperty(Year.parse("2014"));
    ...
    /**
     * for {@link Year} property. specify format. expected valid if input value is before(less than) value parsed specified
     * format.
     * @throws Throwable
     */
    @Test
    ...
    @Data
    public class BeforeForJSR310TestForm {
        @Before.List({
                @Before("2015-10-01"),
                @Before(value = "2015年10月01日", format = "uuuu年MM月dd日", groups = { SpecifyFormat.class }),
                @Before(value = "2015-10-01", format = "uuuu年MM月dd日", groups = { IllegalFormat.class }) })
        private LocalDate localDateProperty;

        @Before.List({
                @Before("2015-10-01T00:00:00"),
                @Before(value = "2015年10月01日00時00分00秒", format = "uuuu年MM月dd日HH時mm分ss秒", groups = { SpecifyFormat.class }),
                @Before(value = "2015-10-01T00:00:00", format = "uuuu年MM月dd日HH時mm分ss秒", groups = { IllegalFormat.class }) })
        private LocalDateTime localDateTimeProperty;

        @Before.List({
                @Before("2015-10-01T00:00:00+09:00[Asia/Tokyo]"),
                @Before(value = "2015年10月01日00時00分00秒+09:00 JST", format = "uuuu年MM月dd日HH時mm分ss秒xxxxx zzz", groups = { SpecifyFormat.class }),
                @Before(value = "2015-10-01T00:00:00+09:00[Asia/Tokyo]", format = "uuuu年MM月dd日HH時mm分ss秒xxxxx zzz", groups = { IllegalFormat.class }) })
        private ZonedDateTime zonedDateTimeProperty;

        @Before.List({
                @Before("15:10:01"),
                @Before(value = "15時10分01秒", format = "HH時mm分ss秒", groups = { SpecifyFormat.class }),
                @Before(value = "15:10:01", format = "HH時mm分ss秒", groups = { IllegalFormat.class }) })
        private LocalTime localTimeProperty;

        @Before.List({
                @Before("2015-10-01T00:00:00+09:00"),
                @Before(value = "2015年10月01日00時00分00秒+09:00", format = "uuuu年MM月dd日HH時mm分ss秒xxxxx", groups = { SpecifyFormat.class }),
                @Before(value = "2015-10-01T00:00:00+09:00", format = "uuuu年MM月dd日HH時mm分ss秒xxxxx", groups = { IllegalFormat.class }) })
        private OffsetDateTime offsetDateTimeProperty;

        @Before.List({
                @Before("15:10:01+09:00"),
                @Before(value = "15時10分01秒+09:00", format = "HH時mm分ss秒xxxxx", groups = { SpecifyFormat.class }),
                @Before(value = "15:10:01+09:00", format = "HH時mm分ss秒xxxxx", groups = { IllegalFormat.class }) })
        private OffsetTime offsetTimeProperty;

        @Before.List({
                @Before("2015"),
                @Before(value = "2015年", format = "uuuu年", groups = { SpecifyFormat.class }),
                @Before(value = "2015", format = "uuuu年", groups = { IllegalFormat.class }) })
        private Year yearProperty;

        @Before.List({
                @Before("2015-10"),
                @Before(value = "2015年10月", format = "uuuu年MM月", groups = { SpecifyFormat.class }),
                @Before(value = "2015-10", format = "uuuu年MM月", groups = { IllegalFormat.class }) })
