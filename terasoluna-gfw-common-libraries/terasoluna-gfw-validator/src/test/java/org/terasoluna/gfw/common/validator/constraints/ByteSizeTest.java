...
public class ByteSizeTest extends AbstractConstraintsTest<ByteSizeTestForm> {
     ...
     * and {@link Integer#MAX_VALUE} value. If you set the number of digits of the format string of
     * the argument of String#format to Integer.MAX_VALUE and execute it, OutOfMemoryError will
     * occur due to the problem of the specification of the execution environment, so the test will
     * be skipped.
     */
