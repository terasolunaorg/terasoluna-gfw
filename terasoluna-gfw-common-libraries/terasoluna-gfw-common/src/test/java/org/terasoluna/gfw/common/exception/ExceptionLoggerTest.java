...
public class ExceptionLoggerTest {
    ...
    public void testWarn_application_is_enabled() {
        ...
        String expectedLogMessage = "[code01] system error.";
        verifyLogging(expectedLogMessage, Level.WARN, ex, mockApplicationLoggerAppender);
        verify(mockMonitoringLoggerAppender, times(0)).doAppend(any(ILoggingEvent.class));
    }
    ...
    public void testWarn_monitoring_is_enabled() {
        ...
        // do assert.
        String expectedLogMessage = "[code01] system error.";
        verify(mockApplicationLoggerAppender, times(0)).doAppend(any(ILoggingEvent.class));
        verifyLogging(expectedLogMessage, Level.WARN, mockMonitoringLoggerAppender);
    ...
    public void testExceptionLogger_default() {
        ...
        assertThat(monitoringLogger.getName()).isEqualTo(testTarget.getClass().getName() + ".Monitoring");
    }
    ...
    public void testExceptionLogger_LogMessageFormat_isNull() {
        ...
        assertThat(e.getMessage()).isEqualTo("logMessageFormat must have placeholder({0} and {1}). {0} is replaced with exception code. {1} is replaced with exception message. current logMessageFormat is \"null\".");
    ...
    public void testExceptionLogger_LogMessageFormat_isBlank() {
        ...
        assertThat(e.getMessage()).isEqualTo("logMessageFormat must have placeholder({0} and {1}). {0} is replaced with exception code. {1} is replaced with exception message. current logMessageFormat is \"\".");
    ...
    public void testExceptionLogger_LogMessageFormat_notContainsPlaceholderOfExceptionCode() {
        ...
        assertThat(e.getMessage()).isEqualTo("logMessageFormat must have placeholder({0} and {1}). {0} is replaced with exception code. {1} is replaced with exception message. current logMessageFormat is \"{1}\".");
    ...
    public void testExceptionLogger_LogMessageFormat_notContainsPlaceholderOfExceptionMessage() {
        ...
        assertThat(e.getMessage()).isEqualTo("logMessageFormat must have placeholder({0} and {1}). {0} is replaced with exception code. {1} is replaced with exception message. current logMessageFormat is \"{0}\".");
     ...
     */
    private void verifyLogging(final String expectedLogMessage, final Level expectedLogLevel,
            final Exception expectedException, final Appender<ILoggingEvent> mockAppender) {
        ...
        verify(mockAppender).doAppend(argThat(argument -> {
            ...
            if (!expectedException.getClass().getName().equals(proxy.getClassName())) {
                return false;
            }
