...
@Retention(RUNTIME)
@Target(METHOD)
@ResourceMustBeFound(notFoundIs = NotFoundCondition.NULL)
public @interface ResourceMustNotNull {

    @AliasFor(annotation = ResourceMustBeFound.class, attribute = "value")
    String code();
}
