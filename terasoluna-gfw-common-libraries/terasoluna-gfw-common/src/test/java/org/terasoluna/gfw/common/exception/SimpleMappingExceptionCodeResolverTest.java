...
public class SimpleMappingExceptionCodeResolverTest {
    ...
    /**
     * [resolveExceptionCode] Case of occur system exception(code not extist) & exists exception
     * mapping.
     * <p>
     * [Expected Result]
     * <ol>
    ...
    /**
     * [resolveExceptionCode] Case of occur other exception & real class's define exists exception
     * mapping.
     * <p>
     * [Expected Result]
     * <ol>
    ...
    /**
     * [resolveExceptionCode] Case of occur other exception & parent class's define exists exception
     * mapping.
     * <p>
     * [Expected Result]
     * <ol>
    ...
    /**
     * [resolveExceptionCode] Case of occur other exception & root class's define exists exception
     * mapping.
     * <p>
     * [Expected Result]
     * <ol>
    ...
    public void testResolveExceptionCode_other_exception_multiple_definitions() {
        ...
        // do test.
        String actualExceptionCode1 =
                testTarget.resolveExceptionCode(new SystemException(null, "syserror"));
        String actualExceptionCode2 =
                testTarget.resolveExceptionCode(new FileNotFoundException("filenotfounderror"));
        String actualExceptionCode3 =
                testTarget.resolveExceptionCode(new NullPointerException("nullerror"));
        String actualExceptionCode4 =
